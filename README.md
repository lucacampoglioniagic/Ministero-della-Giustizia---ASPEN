...
20. **Aperto** — PCF Cruscotto ASPEN (`CaricoMagistratiChart`) ancora bindato a dati/nomi della vecchia tabella `agc_giudice`, canestro vuoto nei drill-down; PCF "Carico per Canestro" da riaggiungere sulla form Contatto (magistrato), dov'era presente sulla vecchia form Magistrato.
